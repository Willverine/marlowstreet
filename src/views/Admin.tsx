...
export const Admin = withAuthenticator(() => {
  ...
  return (<header>
    ...
    >
      ...
      <button onClick={createSeasonMutation}>Click to create new week</button>
      <input type="text" ref={teamName}></input>
      <button onClick={createSeasonMutation}>Click to create new team</button>
      ...
      <button onClick={createPlayerMutation}>Click to create new player</button>
    </div>
  </header>);
});
